...
object QuestionsRandomizer {
    ...
    private fun quotes(): Map<Int, String> {
        return mapOf(
            ...
            44 to "''To nie ubóstwo nas nęka, tylko pragnienie bogactwa.''",
            ...
            53 to "''Ludzie istnieją dla siebie wzajemnie. Albo ich więc pouczaj, albo znoś.''",
            ...
            62 to "''Życie szczęśliwe to życie zgodne ze swoją naturą.''",
            ...
            91 to "''Jeżeli ktoś ci oznajmi, że jakiś człowiek źle mówi o tobie, nie broń sie przeciw zarzutą ale odpowiedz: na pewno nie wiedział on o innych błędach, w przeciwnym razie nie mówiłby tylko o tych.''",
            ...
            99 to "''Celem człowieka jest rozważny wybór rzeczy, które są zgodne z naturą.''",
